   ...
   public static class AutoMapperConfig
    {
        ...
        public static void RegisterAutoMappings()
        {
            ...
            //O código abaixo não vai rodar

            //Customiza o mapeamento individualmente de cada propriedade
            Mapper.Initialize(mapper =>
                {
                    mapper.CreateMap<Funcionario, FuncionarioViewModel>()
                        ...
                        .ForMember(viewModel => viewModel.Contrato, domainMap => domainMap.MapFrom(domain => domain.Contrato))
                        .ForMember(viewModel => viewModel.Documento, domainMap => domainMap.MapFrom(domain => domain.Documento))
                        .ForMember(viewModel => viewModel.EstadoCivil, domainMap => domainMap.MapFrom(domain => domain.EstadoCivil));
                }
            );
        }
